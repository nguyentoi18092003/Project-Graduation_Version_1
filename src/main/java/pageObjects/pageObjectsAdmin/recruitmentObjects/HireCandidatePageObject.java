...
import pageUIs.pageUIsAdmin.recruitmentUIs.HireCandidatePageUI;
...
public class HireCandidatePageObject extends SubMenuRecruitmentPageObject {
    WebDriver driver;

    public HireCandidatePageObject(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    public String getApplicationStatus() {
        waitForElementVisible(driver, HireCandidatePageUI.APPLICATION_STATUS);
        String text = getElementText(driver, HireCandidatePageUI.APPLICATION_STATUS);
        return text.replace("Status:", "").trim();
    }
    public Map<String, String> HireCandidateFromDB(String email) {
