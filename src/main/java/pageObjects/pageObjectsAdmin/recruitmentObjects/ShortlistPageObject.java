...
import pageUIs.pageUIsAdmin.recruitmentUIs.ShortlistCandidatePageUI;
...
public class ShortlistPageObject extends SubMenuRecruitmentPageObject {
    WebDriver driver;

    public ShortlistPageObject(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    public String getApplicationStatus() {
        waitForElementVisible(driver, ShortlistCandidatePageUI.APPLICATION_STATUS);
        String text = getElementText(driver, ShortlistCandidatePageUI.APPLICATION_STATUS);
        return text.replace("Status:", "").trim();
    }
    public Map<String, String> ShortlistCandidateFromDB(String email) {
