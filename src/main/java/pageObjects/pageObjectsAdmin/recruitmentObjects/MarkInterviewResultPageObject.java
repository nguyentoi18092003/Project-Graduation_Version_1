...
import pageUIs.pageUIsAdmin.recruitmentUIs.MakeInterviewResultPageUI;
...
public class MarkInterviewResultPageObject  extends SubMenuRecruitmentPageObject {
    WebDriver driver;

    public MarkInterviewResultPageObject(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    public String getApplicationStatus() {
        waitForElementVisible(driver, MakeInterviewResultPageUI.APPLICATION_STATUS);
        String text = getElementText(driver, MakeInterviewResultPageUI.APPLICATION_STATUS);
        return text.replace("Status:", "").trim();
    }
    public Map<String, String> MarkInterviewResultCandidateFromDB(String email) {
